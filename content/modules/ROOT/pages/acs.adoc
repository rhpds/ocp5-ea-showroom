...
* Open the OpenShift Lightspeed dialog (the icon at the bottom right of the interface). Ask Lightspeed to create a shortcut to the ACS console:
+
...
* Log into the ACS console by clicking the 'ACS' link you just created. The username is *admin* and the password can be obtained, using the OpenShift User Interface, by clicking on *Workloads*, *Secrets*, setting the project to *ACS* and clicking on the *central-admin-password* secret. You can use the 'copy' icon next to the *password* field to copy the password to the clipboard.
+
